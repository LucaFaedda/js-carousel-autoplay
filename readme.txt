...
Consigli:
*Concentratevi sul funzionamento dell'autoplay senza preoccuparvi inizialmente dell'interazione con i pulsanti. Concentratevi su questo aspetto solo in un secondo momento.
* Pensate prima in italiano.
* Dividete in piccoli problemi la consegna.
* Individuate gli elementi di cui avete bisogno per realizzare il programma.
Bonus (da fare solo se avete terminato la parte obbligatoria):
